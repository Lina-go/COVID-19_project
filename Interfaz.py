...
class Interfaz:
    ...
    def __init__(self, ventanta):
        ...
        self.h0.set('0')
        self.T.set('10.0')
        self.tiempo1.set('0.0')
        self.tiempo2.set('150.0')
        ...
        self.ms_decor1 =  Label(self.frameCorriente,width=1, text='d', font=self.fuente_sec,fg = self.color_blanco, bg =self.color_2) 
        ...
        self.metodos_lbl.place(x=75,y=0.5)
        # Parámetros
        # etiqueta para el parametro Vm_0 y su respectiva entrada para cambiar el parametro

        self.Vm0_lbl =  Label(self.frameParametros,width=5, text='a'+u"\u2091"+":", font=self.fuente_sec,fg = self.color_blanco, bg =self.color_1)
        ...
        self.Vm0_lbl_units =  Label(self.frameParametros,width=3, text='%', font=self.fuente_sec,fg = self.color_blanco, bg =self.color_2)
        self.Vm0_lbl_units.place(x=220,y=60)
        
        # etiqueta para el parametro n_0 y su respectiva entrada para cambiar el parametro

        self.n0_lbl =  Label(self.frameParametros,width=5, text='a'+u"\u1D62"+":", font=self.fuente_sec,fg = self.color_blanco, bg =self.color_1)
        ...
        self.n0_lbl_units =  Label(self.frameParametros,width=3, text='%', font=self.fuente_sec,fg = self.color_blanco, bg =self.color_2)
        self.n0_lbl_units.place(x=220,y=100)

        # etiqueta para el parametro m_0 y su respectiva entrada para cambiar el parametro
        self.m0_lbl =  Label(self.frameParametros,width=5, text=u"\u03B2"+":", font=self.fuente_sec,fg = self.color_blanco, bg =self.color_1)
        ...
        self.h0_lbl =  Label(self.frameParametros,width=5, text=u"\u03C1"+":", font=self.fuente_sec,fg = self.color_blanco, bg =self.color_1)
        ...
        self.T_lbl =  Label(self.frameParametros,width=5, text=u"\u03BC"+":", font=self.fuente_sec,fg = self.color_blanco, bg =self.color_1) 
