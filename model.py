...
def rk2(t0, tf, a_e, a_i, k, gamma, B, phi, u,h = 0.01):
    ...
    return t, ys_RK2, ye_RK2, yi_RK2, yr_RK2, yp_RK2
...
def rk4(t0, tf, a_e, a_i, k, gamma, B, phi, u,h = 0.01):
    ...
    for iter in range(1, len(t)):
        ...
        k12 = ds(ys_RK4[iter - 1] + 0.5 * k11 * h,
                 ye_RK4[iter - 1] + 0.5 * k21 * h,
                 yi_RK4[iter - 1] + 0.5 * k31 * h,
                 yr_RK4[iter - 1] + 0.5 * k41 * h, a_e, a_i, gamma)
        k22 = de(ys_RK4[iter - 1] + 0.5 * k11 * h,
                 ye_RK4[iter - 1] + 0.5 * k21 * h,
                 yr_RK4[iter - 1] + 0.5 * k41 * h, a_e, a_i, k, phi)
        k32 = di(ye_RK4[iter - 1] + 0.5 * k21 * h,
                 yi_RK4[iter - 1] + 0.5 * k31 * h, k, B, u)
        k42 = dr(ye_RK4[iter - 1] + 0.5 * k21 * h,
                 yi_RK4[iter - 1] + 0.5 * k31 * h,
                 yr_RK4[iter - 1] + 0.5 * k41 * h, B, phi, gamma)
        k52 = dp(yi_RK4[iter - 1] + 0.5 * k41 * h, u)

        k13 = ds(ys_RK4[iter - 1] + 0.5 * k12 * h,
                 ye_RK4[iter - 1] + 0.5 * k22 * h,
                 yi_RK4[iter - 1] + 0.5 * k32 * h,
                 yr_RK4[iter - 1] + 0.5 * k42 * h, a_e, a_i, gamma)
        k23 = de(ys_RK4[iter - 1] + 0.5 * k12 * h,
                 ye_RK4[iter - 1] + 0.5 * k22 * h,
                 yr_RK4[iter - 1] + 0.5 * k42 * h, a_e, a_i, k, phi)
        k33 = di(ye_RK4[iter - 1] + 0.5 * k22 * h,
                 yi_RK4[iter - 1] + 0.5 * k32 * h, k, B, u)
        k43 = dr(ye_RK4[iter - 1] + 0.5 * k22 * h,
                 yi_RK4[iter - 1] + 0.5 * k32 * h,
                 yr_RK4[iter - 1] + 0.5 * k42 * h, B, phi, gamma)
        k53 = dp(yi_RK4[iter - 1] + 0.5 * k42 * h, u)

        k14 = ds(ys_RK4[iter - 1] + 0.5 * k13 * h,
                 ye_RK4[iter - 1] + 0.5 * k23 * h,
                 yi_RK4[iter - 1] + 0.5 * k33 * h,
                 yr_RK4[iter - 1] + 0.5 * k43 * h, a_e, a_i, gamma)
        k24 = de(ys_RK4[iter - 1] + 0.5 * k13 * h,
                 ye_RK4[iter - 1] + 0.5 * k23 * h,
                 yr_RK4[iter - 1] + 0.5 * k43 * h, a_e, a_i, k, phi)
        k34 = di(ye_RK4[iter - 1] + 0.5 * k23 * h,
                 yi_RK4[iter - 1] + 0.5 * k33 * h, k, B, u)
        k44 = dr(ye_RK4[iter - 1] + 0.5 * k23 * h,
                 yi_RK4[iter - 1] + 0.5 * k33 * h,
                 yr_RK4[iter - 1] + 0.5 * k43 * h, B, phi, gamma)
    ...
    return t, ys_RK4, ye_RK4, yi_RK4, yr_RK4, yp_RK4
...
plt.grid(1)
'''
def scipy(t0, tf, a_e, a_i, k, gamma, B, phi, u,h = 0.01):
    ...
    SolRK45 = inte.solve_ivp(FSystem, [t0, tf], [ys0, ye0, yi0, yr0, yp0], args=(a_e, a_i, gamma, k, u, B, phi),
                             t_eval=t, method='RK45')

    return t, SolRK45.y[0],  SolRK45.y[1],  SolRK45.y[2],  SolRK45.y[3],  SolRK45.y[4]